...
python -u main.py --model GTA --data UCR --data_path ./data/UCR/ --input_len 48 --label_len 24 --variate 1 --out_variate 1 --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 16 --anomaly_ratio 1 --detection_adjustment --retrain --drop 4 --thresh 3 --patience 1 --data_process --LIN

python -u main.py --model GTA --data NAB --data_path ./data/NAB/ --input_len 720 --label_len 30 --variate 1 --out_variate 1 --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 16 --anomaly_ratio 0.5 --detection_adjustment --retrain --drop 4 --thresh 3 --patience 1 --data_process --LIN

python -u main.py --model GTA --data MSDS --data_path ./data/MSDS/ --input_len 720 --label_len 30 --variate 2 --out_variate 2 --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 128 --anomaly_ratio 1 --detection_adjustment --retrain --drop 4 --thresh 3 --patience 1 --data_process --LIN

python -u main.py --model GTA --data SMD --data_path ./data/SMD --partial_data --input_len 720 --label_len 30 --variate 37 --out_variate 37 --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 128 --anomaly_ratio 0.5 --detection_adjustment --retrain --drop 4 --thresh 3 --data_process --LIN

python -u main.py --model GTA --data MSL --data_path ./data/MSL --partial_data --input_len 48 --label_len 24 --variate 34 --out_variate 1 --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 128 --anomaly_ratio 1 --detection_adjustment --retrain --drop 4 --thresh 3 --data_process --LIN

python -u main.py --model GTA --data SMAP --data_path ./data/SMAP --partial_data --input_len 24 --label_len 12 --variate 24 --out_variate 1  --d_model 512 --e_layers 2 --d_layers 1 --dropout 0.05 --itr 5 --learning_rate 0.0001 --batch_size 128 --anomaly_ratio 1 --detection_adjustment --retrain --drop 4 --thresh 3 --data_process --LIN
